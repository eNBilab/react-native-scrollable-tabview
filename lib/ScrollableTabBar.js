...
export default class ScrollableTabBar extends Component {
  constructor(props) {
    ...
    this.measurementsCompleted = this.measurementsCompleted.bind(this)
    this.tabMeasurementsCompleted = this.tabMeasurementsCompleted.bind(this)
  ...
  measurementsCompleted = () => {
    return this.tabMeasurementsCompleted() &&
      this._tabContainerMeasurements &&
      this._containerMeasurements
  }

  tabMeasurementsCompleted = () => {
    const tabCount = this.props.tabs.length
    let allTabMeasured = true
    for (let i = 0; i < tabCount; i++) {
      if ( !this._tabsMeasurements[i] ) {
        allTabMeasured = false
        break
      }
    }
    return allTabMeasured
  }
  ...
  onTabContainerLayout(e) {
    ...
    if ( !this.tabMeasurementsCompleted() ) {
      return
    }
